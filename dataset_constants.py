...
'''
# AVAILABLE DATASETS
AVAILABLE_DATASETS = ['SOY', 'MAIZE', 'SORGHUM-BAP', 'SORGHUM-DIV', 'SORGHUM-NAM', 'SORGHUM-SAP']
...
# Sorghum NAM Constants
SORGHUM_SAP_EXP_NAM = 'SAP'
SORGHUM_SAP_SPECIES_NAME = 'Sorghum bicolor'

SORGHUM_SAP_UNIT_MAP = {
    "seed length": "mm",
    "seed width": "mm",
    "seed mass": "mg",
    "seed mass A": "mg",
